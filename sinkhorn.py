...
argparser.add_argument('-i', '--interactive', action='count',  default=0, required=False, help='whether to plot error interactively on each iteration or not (default not interactive)')
...
if args.method == 'toeplitz':
    ...
    K, a, b = sinkhorn(X, Y, beta=args.beta, max_iter=args.num_iter, eps=args.eps, tol=1e-15, plot_err=args.interactive + 1)
