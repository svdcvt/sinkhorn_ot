...
argparser.add_argument('--path', default='.', type=str, required=False, help='dir path to save')
...
if shape in ['disk', 'flower']:
    ...
    while args.radius > args.side and shape == 'disk':
    ...
    if shape == 'ball':
        is_shape = x**2 + y**2 + z**2 <= args.radius
